...
const EditJadwal = ({ treatment, jadwal }) => {
    ...
    if (jadwal) {
        useEffect(() => {
            setData((prevData) => ({
                ...
                treatment_id: jadwal.treatment_id || "",
                hari: jadwal.hari || "",
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.jadwal.update", jadwal.id ), {
            preserveScroll: true,
            onSuccess: () => {
                reset(), document.getElementById("edit_jadwal").click();
            },
        });
    };
